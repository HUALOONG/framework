...
/**
 * 隔离级别管理器：将 core 的 {@link TransactionDefinition.Isolation} 映射为 JDBC {@link Connection} 隔离级别常量。
 *
 * @author 王飞
 * @since 2026-08-25
 */
...
public final class IsolationLevelManager {
     ...
     */
    public static int toJdbc(TransactionDefinition.Isolation isolation) {
    ...
    private static @Nullable String unused() {
        return Desensitizer.getInstance().mask("13800000000");
    }
}
