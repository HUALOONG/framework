 ...
 * 企业微信机器人消息发送器（骨架）。
 *
 * <p>接入企业微信群机器人时，实现 {@link #doSend(String, String, String)} 即可。
 *
 * @author 王飞
 * @since 0.0.1
 * @version 0.0.1
 */
@NullMarked
public abstract class WeComMessageSender implements MessageSender {
    ...
    public final void send(Message message) {
        Assert.hasText(message.getContent(), "企业微信消息内容不能为空");
        try {
